...
| 1-5 | Event Builder オンラインパイプライン統合 | **高** | 下記 Goal 1-EB 参照 | 大 | 🔧 Phase 0-3 完了 (統一パイプライン + Offline CLI) |
...
| EB-4.6 | **Online EB → 統一パイプライン移行 (ZmqHitSource)** | **高** | 中 | 📋 Phase 4 未着手 |
| EB-4.7 | **レガシーコード削除 (SliceBuilder, L1Builder)** | **中** | 小 | 📋 Phase 5 未着手 |
...
- [ ] EB-4.6: Online EB → 統一パイプライン移行 (ZmqHitSource + Pipeline)
- [ ] EB-4.7: レガシーコード削除 (SliceBuilder, L1Builder, time_slice, time_sort)
