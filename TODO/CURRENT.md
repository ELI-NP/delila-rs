...
**Updated:** 2026-05-06（**Refactor Sprint Phase 2 R-D6 + R-D7 + R-D1/D2 完了** [TODO 52](52_refactor_sprint_2026-q2.md) — decoder family を 2 種類の zero-cost generic 抽象でまとめ、 reader/mod.rs を分割。 **R-D6 (PSD1/PHA1)** = `Dig1Decoder<V: Dig1Variant>`、 3 PR (`649980f` `a5b5398` `37d252a`)、 family -1531 行。 **R-D7 (PSD2/PHA2)** = `Dig2Decoder<V: Dig2Variant>`、 3 PR (`23274d4` `14ee5cd` `53696b5`)、 family -680 行。 **R-D1/D2 (read_loop split)** = 1 PR (`1059709`)、 reader/mod.rs 4000→3112 (-888、 -22%)、 +read_loop_dig1.rs 463 / read_loop_dig2.rs 470 行。 **decoder family 累計 -2211 行 + reader/mod.rs -888 行**。 560 tests pass、 clippy clean、 公開 API 完全互換。 残 Phase 2: R-C1/C2 (config tables) / R-P3/P4/P5 / R-X1）
...
|----------|------|--------|---------|
| **0** | [52_refactor_sprint_2026-q2.md](52_refactor_sprint_2026-q2.md) | **🚧 Phase 1 + Phase 2 R-D6 + R-D7 + R-D1/D2 完了 (2026-05-06)** | **decoder family + reader/mod.rs split**: ① **R-D6 (PSD1/PHA1)** = `Dig1Decoder<V: Dig1Variant>`、 3 PR (`649980f` `a5b5398` `37d252a`)、 family -1531 行。 ② **R-D7 (PSD2/PHA2)** = `Dig2Decoder<V: Dig2Variant>`、 3 PR (`23274d4` `14ee5cd` `53696b5`)、 family -680 行。 ③ **R-D1/D2 (read_loop split)** = 1 PR (`1059709`)、 reader/mod.rs 4000→3112 (-888、 -22%)、 +read_loop_dig1.rs 463 + read_loop_dig2.rs 470 行 (純粋機械的 move、 関数本体バイト同一)。 **累計 decoder -2211 行 + reader/mod.rs -888 行**、 560 tests pass、 clippy clean、 公開 API 完全互換。 残 Phase 2: R-C1/C2 (config tables) / R-P3/P4/P5 / R-X1 |
