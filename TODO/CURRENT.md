...
**Updated:** 2026-05-06（**Refactor Sprint Phase 2 R-D6 + R-D7 + R-D1/D2 + R-C1 完了** [TODO 52](52_refactor_sprint_2026-q2.md) — decoder family を zero-cost generic でまとめ、 reader/mod.rs を分割、 add_channel_params をテーブル駆動化。 **R-D6 (PSD1/PHA1)** = 3 PR、 family -1531 行。 **R-D7 (PSD2/PHA2)** = 3 PR、 family -680 行。 **R-D1/D2 (read_loop split)** = 1 PR (`1059709`)、 reader/mod.rs -888 行。 **R-C1 (channel param tables)** = 1 PR (`aff8ccd`)、 add_channel_params 497→35 行 (-93%)、 digitizer.rs -451 行、 +channel_param_tables.rs 360 行 (4 const テーブル合計 121 entries、 non-capturing closure → fn pointer coercion で const 化)。 **累計 decoder -2211 行 + reader/mod.rs -888 行 + digitizer.rs -451 行**。 572 tests pass、 clippy clean、 公開 API 完全互換。 残 Phase 2: R-C2 (merge_field! derive macro) / R-P3/P4/P5 / R-X1）
...
|----------|------|--------|---------|
| **0** | [52_refactor_sprint_2026-q2.md](52_refactor_sprint_2026-q2.md) | **🚧 Phase 1 + Phase 2 R-D6 + R-D7 + R-D1/D2 + R-C1 完了 (2026-05-06)** | **4 系統の構造リファクタ landed**: ① **R-D6 (PSD1/PHA1)** = `Dig1Decoder<V>`、 3 PR (`649980f` `a5b5398` `37d252a`)、 family -1531 行。 ② **R-D7 (PSD2/PHA2)** = `Dig2Decoder<V>`、 3 PR (`23274d4` `14ee5cd` `53696b5`)、 family -680 行。 ③ **R-D1/D2 (read_loop split)** = 1 PR (`1059709`)、 reader/mod.rs 4000→3112 (-888)、 +read_loop_dig1.rs 463 + read_loop_dig2.rs 470 行。 ④ **R-C1 (channel param tables)** = 1 PR (`aff8ccd`)、 const テーブル駆動で add_channel_params 497→35 行 (-93%)、 digitizer.rs 3080→2629 (-451)、 +channel_param_tables.rs 360 行 (4 const テーブル合計 121 entries、 non-capturing closure → fn ptr で const 化)。 **累計 decoder -2211 + reader/mod.rs -888 + digitizer.rs -451 = -3550 行**、 572 tests pass、 clippy clean、 公開 API 完全互換。 残 Phase 2: R-C2 (merge_field! derive macro) / R-P3/P4/P5 / R-X1 |
