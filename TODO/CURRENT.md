...
**Updated:** 2026-05-06（**Refactor Sprint Phase 2 R-D6 完了** [TODO 52](52_refactor_sprint_2026-q2.md) — `Dig1Decoder<V: Dig1Variant>` generic で PSD1/PHA1 統合、 3 PR landed: PR1 `649980f` 共通モジュール additive、 PR2 `a5b5398` Psd1 type alias 化、 PR3 `37d252a` Pha1 type alias 化。 family net -1531 行 (psd1 1886→405 / pha1 1824→455 / +common 1319)、 561 tests pass、 clippy clean、 公開 API 不変。 R-D9 で予告した `decode_physics_word` 命名統一も同時に実装。 Phase 1 完了報告は前回更新参照: state.rs 抽出 / extract_bits! macro / FirmwareCapabilities / devtree_paths / dev-tools feature gate / zmq_helper / Operator CommandHandlerExt / ECharts utility / R-X3 baseline benchmark など 13 項目）
...
|----------|------|--------|---------|
| **0** | [52_refactor_sprint_2026-q2.md](52_refactor_sprint_2026-q2.md) | **🚧 Phase 1 完了 + Phase 2 R-D6 完了 (2026-05-06)** | **Phase 2 R-D6 (PSD1/PHA1 generic Decoder)** 完了 — 3 PR で `Dig1Decoder<V: Dig1Variant>` zero-cost monomorphization パターンへ移行。 PR1 `649980f` (common module additive、 31 MockVariant tests)、 PR2 `a5b5398` (psd1 1886→405、 -78%)、 PR3 `37d252a` (pha1 1824→455、 -75%)、 family net -1531 行、 561 tests pass、 clippy clean、 公開 API 不変。 Phase 1 完了 13 項目の詳細は前回更新参照。 残 Phase 2: R-D7/D1/D2/C1/C2/P3/P4/P5/X1 |
