...
**Updated:** 2026-05-06（**Refactor Sprint Phase 2 R-D6 + R-D7 完了** [TODO 52](52_refactor_sprint_2026-q2.md) — decoder family を 2 種類の zero-cost generic 抽象でまとめた。 **R-D6 (PSD1/PHA1)** = `Dig1Decoder<V: Dig1Variant>`、 3 PR (`649980f` `a5b5398` `37d252a`)、 family net -1531 行。 **R-D7 (PSD2/PHA2)** = `Dig2Decoder<V: Dig2Variant>`、 3 PR (`23274d4` `14ee5cd` `53696b5`)、 family net -680 行 (psd2 1316→196 -85% / pha2 1086→392 -64% / +dualchannel_common 1134)。 **decoder family 累計 -2211 行**、 560 tests pass、 clippy clean、 公開 API 完全互換 (Psd2Config/Pha2Config/Psd1Config/Pha1Config の struct リテラル + ::new + .decode 等そのまま)。 PHA2 の critical regressions (DP4 truncation + probe metadata + start signal real bytes) 全保持。 PSD2 logging が println! → `tracing` 統一。 残 Phase 2: R-D1/D2 (read_loop split) / R-C1/C2 (config tables) / R-P3/4/5 / R-X1）
...
|----------|------|--------|---------|
| **0** | [52_refactor_sprint_2026-q2.md](52_refactor_sprint_2026-q2.md) | **🚧 Phase 1 + Phase 2 R-D6 + R-D7 完了 (2026-05-06)** | **decoder family を 2 つの generic で統合**: ① **R-D6 (PSD1/PHA1)** = `Dig1Decoder<V: Dig1Variant>`、 3 PR (`649980f` `a5b5398` `37d252a`)、 family -1531 行 (3710→2179)。 ② **R-D7 (PSD2/PHA2)** = `Dig2Decoder<V: Dig2Variant>`、 3 PR (`23274d4` `14ee5cd` `53696b5`)、 family -680 行 (2402→1722)。 **decoder family 累計 -2211 行**、 560 tests pass (PHA2 critical regressions DP4 / probe metadata / real bytes 全保持)、 clippy clean、 公開 API 完全互換。 PSD2 logging が println! → `tracing` に統一。 Phase 1 完了 13 項目詳細は前回更新参照。 残 Phase 2: R-D1/D2 (read_loop split) / R-C1/C2 (config tables) / R-P3/P4/P5 / R-X1 |
