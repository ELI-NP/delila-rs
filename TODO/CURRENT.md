...
**Updated:** 2026-05-06（**Refactor Sprint Phase 1 完了** [TODO 52](52_refactor_sprint_2026-q2.md) — 13 R-* 項目すべて 1 セッションで landed: state.rs 抽出 / extract_bits! macro / opendpp smell / FirmwareCapabilities / devtree_paths / set_in_run base+diff / dev-tools feature gate / zmq_helper 統合 / cargo outdated CI / Operator CommandHandlerExt / ECharts utility / **R-X3 baseline benchmark on Mac + gant** (`docs/plans/zmq_boundary_cost_2026-Q2.md`)。598 unit tests pass (+30)、ng test 68 pass (+11)、clippy clean。 R-X3 結果 = encode+decode 0.25 µs/ev (Mac M4 Pro) / 0.44 µs/ev (gant Xeon) → 4 MHz aggregate で 1 コア飽和ライン → **monolithic 化は引き続きしない方針 (D7 reaffirmed)**。Phase 2 (R-D6 PSD1/PHA1 generic Decoder から) 着手可。当初 5/12 着手予定だったが前倒し可能。来週ランは March bin 固定 → daily merge to master 戦略は維持）
...
|----------|------|--------|---------|
| **0** | [52_refactor_sprint_2026-q2.md](52_refactor_sprint_2026-q2.md) | **🚧 Phase 1 完了 (2026-05-06)、Phase 2 着手可** | **Phase 1 (mechanical cleanup) 1 セッションで完了**: R-D4 state.rs 抽出 / R-D8 extract_bits! macro / R-D9 PSD1↔PHA1 doc / R-D10 opendpp smell / R-C3 FirmwareCapabilities / R-C4 devtree_paths / R-C5 set_in_run base+diff / R-C6 dev-tools feature gate / R-X2 cargo outdated CI / R-X3 zmq_boundary_bench scaffold + Mac/gant baseline / R-P1 zmq_helper 12 site 統合 / R-P2 ECharts utility / R-P7 Operator CommandHandlerExt。598 tests pass (+30)、ng test 68 (+11)、clippy clean、 dist/ 再ビルド済。 **R-X3 結果**: encode+decode 0.25 µs/ev (Mac) / 0.44 µs/ev (gant) → 4 MHz で 1 コア飽和、 D7 (component system 維持) 再確認。Phase 2 着手可 (R-D6 PSD1/PHA1 generic Decoder から)、当初 5/12 着手予定だったが前倒し可。詳細は [clean_architecture_evaluation.md](../clean_architecture_evaluation.md) と [TODO 52](52_refactor_sprint_2026-q2.md) の Status Summary |
