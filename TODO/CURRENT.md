...
|----------|------|--------|---------|
| **0** | [52_refactor_sprint_2026-q2.md](52_refactor_sprint_2026-q2.md) | **📋 計画完了 (2026-05-05 revised evening)、5/12 着手予定** | post-PHA2 重複削減 + **component system 維持** で構造整理 (D7、 同日朝の Pure 一枚岩 D3 を撤回)。28 candidates + 新 R-P8 (Component lifecycle trait / ComponentRunner builder) / 3 phase / 11 週間。来週 March bin ラン中も並行可 (Phase 1 mechanical cleanup は動作不変)。Phase 2 末 (Week 8、 〜2026-07-03) で baseline freeze、Phase 3 で **delayed reader split (R-D3/D5) + R-P8 lifecycle 統一 + 7/24 実験前 stabilize**。詳細は [clean_architecture_evaluation.md](../clean_architecture_evaluation.md) (file:line citation + 工数/リスク/Impact、 §Changelog で revision 経緯)。Gemini Flash の `REFACTORING_SUGGESTIONS.md` (高レベル提案) も統合済 (R-X1/R-X2) |
