...
/// 1-bit Wave Selector
pub const REG_SELECTOR_WAVE: u32 = 0xC00000;
/// 32-bit Pretrig Input
pub const REG_PRETRIGGER_INPUT: u32 = 0xC00001;
/// 1-bit Polarity
pub const REG_POLARITY: u32 = 0xC00002;
/// 16-bit DC Offset
pub const REG_OFFSET: u32 = 0xC00003;
/// 32-bit Threshold
pub const REG_THRS: u32 = 0xC00004;
/// 16-bit Fast Trig Rise
pub const REG_TRIG_K: u32 = 0xC00005;
/// 16-bit Fast Trig Decay
pub const REG_TRIG_M: u32 = 0xC00006;
/// 16-bit Trap Rise
pub const REG_TRAP_K: u32 = 0xC00007;
/// 16-bit Trap Decay
pub const REG_TRAP_M: u32 = 0xC00008;
/// 24-bit Deconvolution
pub const REG_DECONV_M: u32 = 0xC00009;
/// 24-bit Trap Gain
pub const REG_TRAP_GAIN: u32 = 0xC0000A;
/// 4-bit BL Length (MCA)
pub const REG_BL_LEN: u32 = 0xC0000B;
/// 16-bit BL Inhibit
pub const REG_BL_INIB: u32 = 0xC0000C;
/// 16-bit Sample Pos
pub const REG_SAMPLE_POS: u32 = 0xC0000D;
/// 1-bit Run Enable
pub const REG_RUN_CFG: u32 = 0xC0000F;
/// 32-bit AMax Window
pub const REG_AMAX_WINDOW: u32 = 0xC00012;
/// 32-bit Max Window
pub const REG_WINDOW_MAXIM: u32 = 0xC00014;
/// 16-bit AMax Length
pub const REG_AMAX_LEN: u32 = 0xC00015;
/// 32-bit BL Delay (AMax)
pub const REG_BASELINE_DELAY: u32 = 0xC00017;
/// 16-bit BL Length (AMax)
pub const REG_BASELINE_LEN: u32 = 0xC00018;
/// 16-bit BL Offset (AMax)
pub const REG_BASELINE_OFFSET: u32 = 0xC00019;
/// 32-bit Pretrig Trap
pub const REG_PRETRIGGER_TRAP: u32 = 0xC0001E;
/// 32-bit Pretrig AMax
pub const REG_PRETRIGGER_AMAX: u32 = 0xC0001F;
/// 32-bit Delay Shaping
pub const REG_DELAY_SHAPING: u32 = 0xC00021;
/// 32-bit Shaping Trigger
pub const REG_SHAP_TRIGG: u32 = 0xC20040;
/// 32-bit Shaping BL Hold
pub const REG_SHAP_BL_HOLD: u32 = 0xC20041;
...
/// 1-bit Enable Debug Acquisition (FW reg `ENABLE_ACQ`)
pub const BOARD_REG_ENABLE_ACQ: u32 = 0x80008;
...
#[allow(dead_code)]
pub fn board_writes(
    config: &crate::config::digitizer::AMaxBoardConfig,
) -> Vec<(u32, u32, &'static str)> {
    let mut writes = Vec::new();
    if let Some(v) = config.enable_acq { writes.push((BOARD_REG_ENABLE_ACQ, v, "enable_acq")); }
    writes
}
...
pub fn all_board_registers() -> Vec<(u32, &'static str)> {
    vec![
        (BOARD_REG_ENABLE_ACQ, "enable_acq"),
    ]
}
