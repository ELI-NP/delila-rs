...
/// 1-bit Wave Selector
pub const REG_SELECTOR_WAVE: u32 = 0x100000;
/// 32-bit Pretrig Input
pub const REG_PRETRIGGER_INPUT: u32 = 0x100001;
/// 1-bit Polarity
pub const REG_POLARITY: u32 = 0x100002;
/// 16-bit DC Offset
pub const REG_OFFSET: u32 = 0x100003;
/// 32-bit Threshold
pub const REG_THRS: u32 = 0x100004;
/// 16-bit Fast Trig Rise
pub const REG_TRIG_K: u32 = 0x100005;
/// 16-bit Fast Trig Decay
pub const REG_TRIG_M: u32 = 0x100006;
/// 16-bit Trap Rise
pub const REG_TRAP_K: u32 = 0x100007;
/// 16-bit Trap Decay
pub const REG_TRAP_M: u32 = 0x100008;
/// 24-bit Deconvolution
pub const REG_DECONV_M: u32 = 0x100009;
/// 24-bit Trap Gain
pub const REG_TRAP_GAIN: u32 = 0x10000A;
/// 4-bit BL Length (MCA)
pub const REG_BL_LEN: u32 = 0x10000B;
/// 16-bit BL Inhibit
pub const REG_BL_INIB: u32 = 0x10000C;
/// 16-bit Sample Pos
pub const REG_SAMPLE_POS: u32 = 0x10000D;
/// 1-bit Run Enable
pub const REG_RUN_CFG: u32 = 0x10000F;
/// 32-bit AMax Window
pub const REG_AMAX_WINDOW: u32 = 0x100012;
/// 32-bit Max Window
pub const REG_WINDOW_MAXIM: u32 = 0x100014;
/// 16-bit AMax Length
pub const REG_AMAX_LEN: u32 = 0x100015;
/// 32-bit BL Delay (AMax)
pub const REG_BASELINE_DELAY: u32 = 0x100017;
/// 16-bit BL Length (AMax)
pub const REG_BASELINE_LEN: u32 = 0x100018;
/// 16-bit BL Offset (AMax)
pub const REG_BASELINE_OFFSET: u32 = 0x100019;
/// 32-bit Pretrig Trap
pub const REG_PRETRIGGER_TRAP: u32 = 0x10001E;
/// 32-bit Pretrig AMax
pub const REG_PRETRIGGER_AMAX: u32 = 0x10001F;
/// 32-bit Delay Shaping
pub const REG_DELAY_SHAPING: u32 = 0x100021;
/// 32-bit Shaping Trigger
pub const REG_SHAP_TRIGG: u32 = 0x120040;
/// 32-bit Shaping BL Hold
pub const REG_SHAP_BL_HOLD: u32 = 0x120041;
