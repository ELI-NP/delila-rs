...
#define CAEN_DGTZ_VERSION_MINOR		19																																//!< Minor version
#define CAEN_DGTZ_VERSION_PATCH		0																																//!< Patch version
...
* \deprecated Use CAEN_DGTZ_OpenDigitizer2
*
...
* \return  0 = Success; negative numbers are error codes
******************************************************************************/
CAEN_DGTZ_DEPRECATED(2.18.0, CAEN_DGTZ_OpenDigitizer2,
...
*
* \param   [IN]  LinkType      : The link used by the device
* \param   [IN]  arg:          : See documentation
* \param   [IN]  ConetNode     :
*                         - for CONET identify which device in the daisy-chain is addressed
*                         - for USB must be 0.
* \param   [IN]     VMEBaseAddress: The VME base address of the board in case you want to access a board through VME bus, 0 otherwise.
...
* \return  0 = Success; negative numbers are error codes
******************************************************************************/
CAENDGTZ_DLLAPI CAEN_DGTZ_ErrorCode CAENDGTZ_API CAEN_DGTZ_OpenDigitizer2(CAEN_DGTZ_ConnectionType LinkType, const void* arg, int ConetNode, uint32_t VMEBaseAddress, int* handle);
...
*                                   - CAEN_DGTZ_DPP_QDC_Event_t, for DPP-QDC
*                                   - CAEN_DGTZ_730_DAW_Event_t, for DPP-DAW
*                                   - CAEN_DGTZ_DPP_X743_Event_t, for DPP-CI on X743
...
*                                   - CAEN_DGTZ_DPP_QDC_Waveforms_t, for DPP-QDC
*                                   - CAEN_DGTZ_730_DAW_Waveforms_t, for DPP-DAW
