...
#define CAEN_DGTZ_DEPRECATED_MSG(V, R)	"Deprecated since " #V ". Use " #R
...
#define CAEN_DGTZ_DEPRECATED(V, R, ...)	__declspec(deprecated(CAEN_DGTZ_DEPRECATED_MSG(V, R))) __VA_ARGS__
#else 
#include <sys/time.h>
#include <sys/types.h>
#include <unistd.h>
...
#define CAEN_DGTZ_DEPRECATED(V, R, ...)	__VA_ARGS__ __attribute__((deprecated(CAEN_DGTZ_DEPRECATED_MSG(V, R))))
#endif
...
#define CAEN_DGTZ_ROM_SERIAL_0_V2_ADD                           (0xF070)
#define CAEN_DGTZ_ROM_SERIAL_1_V2_ADD                           (0xF074)
#define CAEN_DGTZ_ROM_SERIAL_2_V2_ADD                           (0xF078)
#define CAEN_DGTZ_ROM_SERIAL_3_V2_ADD                           (0xF07C)
...
#define V1743_DPP_CI_CODE     (0x86)    // The code for the DPP-CI for x743 boards
...
typedef enum CAEN_DGTZ_ConnectionType {
    ...
    CAEN_DGTZ_USB_A4818_V2718            = 2L, /*!< \deprecated Since 2.18. Use ::CAEN_DGTZ_USB_A4818 instead. */
    CAEN_DGTZ_USB_A4818_V3718            = 3L, /*!< \deprecated Since 2.18. Use ::CAEN_DGTZ_USB_A4818 instead. */
    CAEN_DGTZ_USB_A4818_V4718            = 4L, /*!< \deprecated Since 2.18. Use ::CAEN_DGTZ_USB_A4818 instead. */
...
typedef enum
{
    ...
    CAEN_DGTZ_V1784     =43L,   /*!< \brief The board is V1784  */
...
typedef enum {
    ...
    // NOTE: 15 is Hexagon
	CAEN_DGTZ_XX782_FAMILY_CODE  = 16L, // NOTE: 16 is shared by XX741
    CAEN_DGTZ_XX784_FAMILY_CODE  = 0x84L,
