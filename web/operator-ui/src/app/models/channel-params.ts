...
const AMAX_INPUT_PARAMS: ChannelParamDef[] = [
  { key: 'amax.polarity', label: 'Polarity', type: 'enum', options: ['0', '1'] }, // 0=neg, 1=pos
...
const AMAX_TRIGGER_PARAMS: ChannelParamDef[] = [
  { key: 'amax.thrs', label: 'Threshold', type: 'number', min: 0, max: 1_000_000, step: 1 },
...
// Energy tab packs three AMax sub-sections (trapezoid + AMax HLS + baseline).
// Keeping them in one tab matches the three other firmwares' UX.
const AMAX_ENERGY_PARAMS: ChannelParamDef[] = [
  // Trapezoidal Filter (MCA HLS)
  ...
  { key: 'amax.deconv_m', label: 'Deconvolution', type: 'number', min: 0, max: 16_777_215, step: 1 },
  { key: 'amax.trap_gain', label: 'Trap Gain', type: 'number', min: 0, max: 16_777_215, step: 1 },
  ...
  // AMax peak detector
  { key: 'amax.amax_window', label: 'AMax Window', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  { key: 'amax.amax_delay', label: 'AMax Delay', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  { key: 'amax.amax_len', label: 'AMax Length', type: 'number', unit: 'samp', min: 0, max: 65535, step: 1 },
  { key: 'amax.window_maxim', label: 'Max Window', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  // Baseline (AMax HLS)
  { key: 'amax.baseline_delay', label: 'BL Delay (AMax)', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  { key: 'amax.baseline_len', label: 'BL Length (AMax)', type: 'number', unit: 'samp', min: 0, max: 65535, step: 1 },
  { key: 'amax.baseline_offset', label: 'BL Offset (AMax)', type: 'number', min: 0, max: 65535, step: 1 },
];

const AMAX_WAVEFORM_PARAMS: ChannelParamDef[] = [
  { key: 'amax.pretrigger_input', label: 'Pretrig Input', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  { key: 'amax.pretrigger_trap', label: 'Pretrig Trap', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  { key: 'amax.pretrigger_amax', label: 'Pretrig AMax', type: 'number', unit: 'samp', min: 0, max: 1_000_000, step: 1 },
  { key: 'amax.selector_wave', label: 'Wave Selector', type: 'enum', options: ['0', '1'] }, // 0=trap, 1=raw
];
